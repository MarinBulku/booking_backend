...
public interface BookingRepository extends JpaRepository<Booking, Integer> {
    ...
    * */
    @Query("SELECT NEW com.algorhythm.booking_backend.adapter.in.models.booking.BookingHistoryDto(b.bookingId, b.room.hotel.hotelName, b.pricePaid, b.startDate, b.status) " +
