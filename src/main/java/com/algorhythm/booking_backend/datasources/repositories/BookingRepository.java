...
public interface BookingRepository extends JpaRepository<Booking, Integer> {
    ...
    * */
    @Query("SELECT NEW com.algorhythm.booking_backend.datasources.datatansferobjects.booking.BookingHistoryDto(b.bookingId, b.room.hotel.hotelName, b.pricePaid, b.startDate, b.status) " +
